...
ALTER TABLE post_property ADD column TENANT_TYPE_ID INT NOT NULL DEFAULT '-1' AFTER TRANSACTION_TYPE_TITLE,
ADD COLUMN TENANT_TYPE_TITLE VARCHAR(255) AFTER TENANT_TYPE_ID,
ADD COLUMN SALE_TYPE_ID INT NOT NULL DEFAULT '-1' AFTER TENANT_TYPE_TITLE,
ADD COLUMN SALE_TYPE_TITLE VARCHAR(255) AFTER SALE_TYPE_ID;


select * From POST_PROPERTY pp 
where PROPERTY_ID  in (6, 186);
