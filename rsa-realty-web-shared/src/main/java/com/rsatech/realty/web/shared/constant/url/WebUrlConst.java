...
public interface WebUrlConst {
    ...
    String URL_REALTY_PROPERTY_RENT  = URL_REALTY_PROPERTY_API_DATA_PREFIX + "/rent";
    String URL_REALTY_PROPERTY_SELL  = URL_REALTY_PROPERTY_API_DATA_PREFIX + "/sell";
    String URL_REALTY_PROPERTY_PG  = URL_REALTY_PROPERTY_API_DATA_PREFIX + "/pg";
}
