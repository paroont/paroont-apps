...
CREATE TABLE POST_PROPERTY (
    ...
    AVAILABILITY_TS TIMESTAMP NULL,
    ...
    POSTED_USER_TYPE_TITLE VARCHAR(255),
...
ALTER TABLE POST_PROPERTY ADD  STATE_ID VARCHAR(255) AFTER AREA_NAME;
ALTER TABLE POST_PROPERTY ADD  CITY_ID VARCHAR(255) AFTER LOCALITY_TITLES;
ALTER TABLE POST_PROPERTY ADD  LANDMARK_ID VARCHAR(255) AFTER STATE_NAME;
ALTER TABLE POST_PROPERTY ADD  AREA_ID VARCHAR(255) AFTER CITY_NAME;
